    ...
    <Modal
      ...
      <View style={styles.modalContainer}>
        <ScrollView style={{width:'100%'}}>
          ...
          <Text
            style={{justifyContent:'center', alignSelf:'center', fontSize:20,color:'black',margin:50}}
            >Registration</Text>
          <TextInput
    ...
    return(
      <View style={styles.container}>
        ...
        <View style={styles.buttonContainer}>
          <Text style={{color:'pink', fontSize:18, fontWeight:'bold',marginLeft:55}}>USERNAME</Text>
